...
var ConfigOptionsInfo = Options{{
	...
	Default: "",
	Help:    "Fronting target hostname used for network dial; original request port is preserved (required with --fronting-enable).",
	Groups:  "Networking",
}, {
	...
	Name:    "fronting_sni",
	Default: "",
	Help:    "TLS SNI override for fronted requests (defaults to --fronting-target) (optional with --fronting-enable).",
	Groups:  "Networking",
}}
